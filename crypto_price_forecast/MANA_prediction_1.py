...
# Load the dataset
df = pd.read_csv('1_Day_Predictions\MANA\MANA_All_Time.csv')
...
for i in range(1, len(train_data_scaled)):
    x_train.append(train_data_scaled[i-1:i, 0])
...
for i in range(1, len(test_data_scaled)):
    x_test.append(test_data_scaled[i-1:i, 0])
...
print("The predicted price for MANA after 1 day is: ", predicted_price)
